...
def get_args():
    parser = argparse.ArgumentParser(description="Simple example of a training script for ProteusID.")

    # ProteusID information
    ...
    parser.add_argument("--FT_txt_dim", type=int, default=4096)
    parser.add_argument("--FT_clip_dim", type=int, default=1280)
    parser.add_argument("--FT_vit_dim", type=int, default=1024)
    parser.add_argument("--FT_num_querie", type=int, default=32)
    parser.add_argument("--FT_depth", type=int, default=10)
    parser.add_argument("--FT_dim_head", type=int, default=64)
    parser.add_argument("--FT_num_heads", type=int, default=64)
    parser.add_argument("--FT_output_dim", type=int, default=4096)
    parser.add_argument("--FT_num_scale", type=int, default=5)
    parser.add_argument("--FT_ff_mult", type=int, default=4)
    parser.add_argument("--FFE_num_queries", type=int, default=32)
    parser.add_argument("--FFE_query_dim", type=int, default=2048)
    parser.add_argument("--FFE_input_img_dim", type=int, default=2048)
    parser.add_argument("--FFE_input_fuse_dim", type=int, default=4096)
    parser.add_argument("--FFE_output_dim", type=int, default=2048)
    parser.add_argument("--FFE_layers", type=int, default=10)
    parser.add_argument("--FFE_heads", type=int, default=32)
    parser.add_argument("--FFE_clip_dim", type=int, default=1280)
    parser.add_argument("--FFE_vit_dim", type=int, default=1024)
    parser.add_argument("--FFE_time_channel", type=int, default=3072)
    parser.add_argument("--FFE_time_embed_dim", type=int, default=2048)
    parser.add_argument("--FFE_timestep_activation_fn", type=str, default="silu")
    # EMA
