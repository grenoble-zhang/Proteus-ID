...
export WANDB_ENTITY="guiyu-zhang"
export WANDB_PROJECT="proteusid"
export WANDB_NAME="8gpu"
export WANDB_MODE="online"
# For training from scratch
export MODEL_PATH="/nfs/dataset-ofs-voyager-research/guiyuzhang/proteusid-code/ProteusID/CogVideoX-5b-I2V"
export CONFIG_PATH="/nfs/dataset-ofs-voyager-research/guiyuzhang/proteusid-code/ProteusID/CogVideoX-5b-I2V"
export TYPE="i2v"
export DATASET_PATH="/nfs/voyager-research-hdd/users/shichen/project/guiyu/RigFace/77yu/video/total_train_data--delete-message.txt"
export OUTPUT_PATH="output_single_8gpu"
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
export NCCL_IB_DISABLE=0
export NCCL_IB_GID_INDEX=3
export NCCL_DEBUG=INFO

python find_free_port.py util/deepspeed_configs/accelerate_config_machine_single.yaml
